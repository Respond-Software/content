...
def main():
    ...
    try:
        ...
        if command == 'test-module':
            ...
            return_outputs(file_command(client))
        elif command == 'ip':
            return_outputs(ip_command(client))
        elif command == 'url':
            return_outputs(url_command(client))
        elif command == 'domain':
            return_outputs(domain_command(client))
            ...
            return_outputs(cs_report_pdf_command(client))
        else:
